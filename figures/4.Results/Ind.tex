\begin{table}
	...
	\begin{tabular}{l|S[table-format=2.6]|S[table-format=2.6]|r|c}
		...
		Huffman - First Index & & & & \\
			...
			\csvreader[head to column names,separator=semicolon,filter strcmp={\type}{huffman-first}]{figures/4.Results/Ind.csv}{}{\hspace{3mm}\tablename & \hpcg & \gflops & \iterations & \rate \\}
