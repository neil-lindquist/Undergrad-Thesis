...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Problems can be large, with millions of variables
...
\begin{frame}
	...
	\begin{tikzpicture}[scale=.9]
		\begin{axis}[xbar,
					...
					ymin=.3,
					ytick            ={0,1,2,3},
					yticklabels={{Baseline},{SZ inds},{Gamma inds},{Delta inds}},
					legend style={
						anchor=east,
						at={(axis description cs:-.4,.4)}
					},
			...
			\addlegendentry{32 bit vals}
			\addplot coordinates{% SZ vals
				(19.5759,1)
				(13.9794,2)
				(11.1961,3)
			};
			\addlegendentry{SZ vals}
