...
Additionally, as shown by the bound on performance improvement found in Section~\ref{sec:results-bounds}, compressing matrix values alone cannot provide performance improvement.
