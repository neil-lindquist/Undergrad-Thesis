...
\review{Make sure that the results shown don't need to be cut down to be understandable}
...
\review{Does there need to be stuff written about SZ, Gamma or Delta compression?}
...
So, a higher window size increases the memory needed, but reduces the total number of lookups to do, providing a trade off between the amount of cache space used up and the average time to decode each value.
