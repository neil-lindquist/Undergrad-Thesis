...
This model was used to create approximate bounds that need to be meet to outperform the baseline implementation.
...
Lastly, the model was only worked with using integral values for the bytes, decode times and encode times.
